...
import inventoryutils.Reference;

public class InventoryUtilsConfigGui extends GuiConfig
{
    public InventoryUtilsConfigGui(GuiScreen parent)
    {
